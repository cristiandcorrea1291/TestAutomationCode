...
public class V73LogicItemsInArrayForClass {

	public static void main(String[] args) throws InterruptedException {
		// TODO Auto-generated method stub
		//Video 73: Building Programming Logic to process items in array for Cart
		...
		for(int i=0;i<products.size();i++) { 
			...
			//entonces brocoli quedaria en el index 0
			//y 1 kg en el index 1
			String name = products.get(i).getText(); // traer el texto de "producto" por el selector "h4.product-name"
			...
			if (itemsNeededList.contains(name)){ // Sí la lista continene el formatedName del arreglo de elementos name
			...
			break; //para salir del loop una vez cumpla la condicion del for o el statement
