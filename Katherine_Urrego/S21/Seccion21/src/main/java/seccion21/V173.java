...
public class V173 {
	...
	//Video 173. Integration of Hashmap to Data provider to send the data as one Hash object
	
	//se muestran los cambiios efectuados en las diferentes partes del codigo
	...
	/*
		...
		se ejeuta el mismo testcase Purchase.xml
