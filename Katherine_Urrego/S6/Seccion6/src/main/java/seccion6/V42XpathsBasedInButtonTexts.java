...
public class V42XpathsBasedInButtonTexts {

	public static void main(String[] args) {		
		//VIDEO 42: Generating xpaths based on the button texts on the page with the example
		//****************************************************************
		...
		//Ir al botón LOG OUT usando el * que permite
