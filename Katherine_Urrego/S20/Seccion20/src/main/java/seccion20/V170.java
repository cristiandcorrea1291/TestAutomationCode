...
public class V170 {
	//VIDEO 170. Create new Test methods with Dependency attribute based on Test Strategy design
	
	
	
	//Crearemos otro metodo para verificar fi el producto ""ZARA COAT 3" se está
	//se está mostrando en la página de OrderPageTest para la pagina donde s emuestran las ordenes
	
	/* en la case SubmitOrderTest
	 * 

	 //se deja esta variable local
