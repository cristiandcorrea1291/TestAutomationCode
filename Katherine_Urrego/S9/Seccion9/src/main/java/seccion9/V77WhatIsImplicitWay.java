...
public class V77WhatIsImplicitWay {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		//VIDEO 77:What is Implicit wait? Explain with real time scenario
		 ...
		 * IMPLICIT WAIT:
		 * El Implicit Wait es una configuración que se aplica a NIVEL GLOBAL para toda la instancia de WebDriver.
		 ...
		 *	ventajas:-> se define a nivel global (antes de cada paso, clic, accion hay un tiempo de espera)
		 *es time limited
		 ...
		 * WebElement element = wait.until(ExpectedConditions.presenceOfElementLocated(By.id("elementId")));
 		...
 		para consultar https://www.selenium.dev/selenium/docs/api/java/org/openqa/selenium/support/ui/FluentWait.html
