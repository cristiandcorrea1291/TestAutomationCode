...
public class Prueba1 {
	...
	/*	Dada la siguiente pagina Web:
		...
		System.out.println(driver.findElement(By.id("totalp")).getText());//muestra el total de 2 productos agregados al carro
	
		System.out.println("muestra el total de los productos");
