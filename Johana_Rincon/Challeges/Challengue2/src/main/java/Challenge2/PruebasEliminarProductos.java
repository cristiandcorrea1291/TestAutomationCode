...
public class PruebasEliminarProductos {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// <a href="#" id="itemc" onclick="byCat('monitor')"
		// class="list-group-item">Monitors</a>
		...
		// <a href="#" onclick="addToCart(10)" class="btn btn-success btn-lg">Add to
		// cart</a>
		...
		// <a href="#" id="itemc" onclick="byCat('phone')"
		// class="list-group-item">Phones</a>
		...
		// agrega el producto
		// <a href="#" onclick="addToCart(3)" class="btn btn-success btn-lg">Add to
		// cart</a>
		driver.findElement(By.linkText("Add to cart")).click();
		...
		// Esperar explicitamente x segundos try es el código que se intenta ejecutar, y
		// si se lanza una excepción durante su ejecución, el flujo de control se
		// redirige al bloque catch para manejar la excepción.
		...
		total_producto = driver.findElement(By.id("totalp")).getText();// muestra el total de 2 productos agregados al
																		// carro
